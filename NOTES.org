...
insert into runno_fileno_sitemask select distinct runno, fileno, sitemask from DqDetectorNew natural join DqDetectorNewVld where sitemask=3 and runno between 21221 and 26694-1 and detectorid <= 3;

insert into runno_fileno_sitemask select distinct runno, fileno, sitemask from DqDetectorNew natural join DqDetectorNewVld where sitemask=3 and runno > 26694 and detectorid <= 4;
