...
- [ ] Dump dq_db
- [ ] Build frontend
- [ ] Delete/restart dybvdq-mysql
- [ ] Load dq_db
- [ ] Build indexes/derived tables
- [ ] Set env vars
...
** Making a snapshot
#+BEGIN_SRC bash
mysqldump -h dybdq.ihep.ac.cn -u dybrw -p --opt dq_db DqDetectorNew DqDetectorNewVld DqLiveTime most_recent_file_tag > dq_db.20180913.sql
#+END_SRC
